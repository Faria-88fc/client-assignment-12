...
const Banner = () => {
    return (
        <div>
            <div>
                <img className='img-fluid' src="../../../../images/jhamdani.jpg" alt=""
                    style={{ height: '95vh', width: '100%', maxHeight: '500px' }}
                />
            </div>

            <div className='container ms-5 mb-5 d-flex flex-wrap'>
                <img className='img-fluid' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_81X1l61w03TLs4eKtRoIavIL9QKWUPbYPA&usqp=CAU" alt=""
